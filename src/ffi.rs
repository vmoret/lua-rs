...
use libc::{c_char, c_double, c_int, c_longlong, c_uchar, c_uint, c_ulonglong, c_ushort, c_void};
use std::{mem, ptr};
...
extern "C" {
    ...
    pub fn lua_version(state: *mut lua_State) -> lua_Number;
    ...
    pub fn lua_pushglobaltable(state: *mut lua_State);
    ...
    pub fn lua_tocfunction(state: *mut lua_State, index: c_int) -> lua_CFunction;
    ...
    pub fn lua_typename(state: *mut lua_State, index: c_int) -> *const c_char;
    ...
    pub fn lua_seti(state: *mut lua_State, index: c_int, n: lua_Integer);
